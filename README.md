...
- One feature of the physics engine is a using an implementation of Separating Axis Theorem. This is done by projecting both onto a series of axis to check if they overlap, then using the axis which does with the least penetration to get a collision point for collision resolution.
