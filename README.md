...
- One feature of the physics engine is a collision detection method between OBB objects. This is done by projecting both onto a series of axis to check if they are colliding.
